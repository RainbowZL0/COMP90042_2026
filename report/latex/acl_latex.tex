...
All reported development numbers are produced by the submitted notebook, Group56.ipynb. We use seed 42 for the main run. The full search is intentionally sequential: retraining rerankers and classifiers for every preprocessing and BM25 combination would multiply the compute cost.
