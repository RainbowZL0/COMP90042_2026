...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.95\columnwidth]{error_analysis_pie_chart.png}
  \caption{Distribution of error-analysis buckets on the development set.
  The buckets are defined by whether the retrieval module retrieves at least one gold evidence passage and whether the classifier predicts the correct label.}
