...
The reranker peaks after one epoch (quick development F 0.1987), then drops to 0.1900 and 0.1784 after epochs two and three. This suggests that the cross-encoder quickly learns useful relevance signals but begins to overfit the 20,610 pair training set.
